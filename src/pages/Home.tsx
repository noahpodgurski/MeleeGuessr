...
import { Button, Container, Grid, Link } from "@suid/material";
    ...
    <>
		<Grid container minHeight="100vh" justifyContent="center" alignItems="center">
			...
			{/* Beta {process.env.REACT_APP_PUBLIC_VERSION} */}
				<h1 class="logo" style={{"text-align": "center", "font-size": "rem"}}>MeleeGuessr</h1>
				<div class="centered">
					<Button href="/play" onClick={() => StocksContext.stocks = STARTING_STOCKS} variant="contained" style={{height: '50px', width: "100px"}}>
						Play
					</Button>
				</div>
