      ...
      <For each={replayStore.renderDatas}>
        {(renderData) => (
          <>
            ...
            />
            {renderData.playerSettings.port ===
              (playStore.currentClip?.portToGuess ?? 0) + 1 &&
        ...
        <circle
          ...
          r={
            isYoshi
              ...
              : props.renderData.characterData.shieldSize *
...
function Other(props: { renderData: RenderData }) {
  return (
    <>
      <Show
        when={
          actionNameById[props.renderData.playerState.actionStateId] ===
          "YoshiEgg"
        }
      >
        <circle
